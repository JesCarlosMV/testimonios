...
2º App.js importa usuarios.js y atraves de un map() recorre cada objeto y devuelve ese objeto (OJO! EL FOREACH NO DEVUELVE EL OBJETO! POR ESO SE USA EL map() )
y por cada objeto hace un componente y envia a ese componente el OBJETO devuelto asi : <Testimonio objUsuario={usuarioSingle} />.
